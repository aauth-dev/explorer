    ...
    <div className="border-b border-amber-500/30 bg-amber-500/5 px-4 py-2.5">
      <div className="mx-auto max-w-6xl flex items-start gap-2 text-xs">
        ...
        <p className="text-muted-foreground leading-relaxed">
          <span className="font-medium text-amber-700 dark:text-amber-100">Pre-rewrite scenario.</span>{" "}
          ...
          the PS. See the{" "}
          <Link href="/bootstrap" className="text-amber-700 dark:text-amber-200 underline underline-offset-2">
            bootstrap overview
          </Link>{" "}
          for current framing.
        </p>
